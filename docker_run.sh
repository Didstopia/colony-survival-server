...
docker run -e SERVER_NAME="Test 2" -e SERVER_PASSWORD="docker" -e PGID="${GID}" -e PUID="${UID}" -p 0.0.0.0:27016:27016/tcp -p 0.0.0.0:27016:27016/udp -p 0.0.0.0:27017:27017/tcp -v "$(pwd)/colonysurvival_data:/steamcmd/colonysurvival" --name colony-survival-server -it --rm didstopia/colony-survival-server:latest
